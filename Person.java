...
public abstract class Person implements Active, Adaptable {
	...
	private static final Person Professor = null;
	private static final Collection<? extends Person> Student = null;
	private static final Person RichStudent2 = null;
	...
	public Person() {
		...
		people.add(Professor); //инстанция на професор
		people.addAll(Student);//инстанция на студент
		people.add(RichStudent2); //инстанция на богат студент2
